...
export const LIDO_VOTING_ADDRESS: string = '0x2e59A20f205bB85a89C53f1936454680651E618e'.toLowerCase();

export const LIDO_EASY_TRACK_ADDRESS: string = '0xF0211b7660680B49De1A7E9f25C65660F0a13Fea'.toLowerCase();

export const LIDO_STAKING_ROUTER_ADDRESS: string = '0xFdDf38947aFB03C621C71b06C9C70bce73f12999'.toLowerCase();

export const LIDO_ACCOUNTING_ORACLE_ADDRESS: string = '0x852deD011285fe67063a08005c71a85690503Cee'.toLowerCase();

export const LIDO_WITHDRAWAL_QUEUE_ADDRESS: string = '0x889edC2eDab5f40e902b864aD4d7AdE8E412F9B1'.toLowerCase();

export const LIDO_HASH_CONSENSUS_ADDRESS: string = '0xD624B08C83bAECF0807Dd2c6880C3154a5F0B288'.toLowerCase();
...
LIDO_ADDRESSES.set('mainnet', '0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84'.toLowerCase())
LIDO_ADDRESSES.set('goerli', '0x1643E812aE58766192Cf7D2Cf9567dF2C37e9B7F'.toLowerCase())
LIDO_ADDRESSES.set('holesky', '0x3F1c547b21f65e10480dE3ad8E19fAAC46C95034'.toLowerCase())

const NOS_ADDRESSES = new Map<string, string>()
NOS_ADDRESSES.set('mainnet', '0x55032650b14df07b85bF18A3a3eC8E0Af2e028d5'.toLowerCase())
NOS_ADDRESSES.set('goerli', '0x9D4AF1Ee19Dad8857db3a45B0374c81c8A1C6320'.toLowerCase())
NOS_ADDRESSES.set('holesky', '0x595F64Ddc3856a3b5Ff4f4CC1d1fb4B46cFd2bAC'.toLowerCase())

const TREASURY_ADDRESSES = new Map<string, string>()
TREASURY_ADDRESSES.set('mainnet', '0x3e40D73EB977Dc6a537aF587D48316feE66E9C8c'.toLowerCase())
TREASURY_ADDRESSES.set('goerli', '0x4333218072D5d7008546737786663c38B4D561A4'.toLowerCase())
TREASURY_ADDRESSES.set('holesky', '0xE92329EC7ddB11D25e25b3c21eeBf11f15eB325d'.toLowerCase())

const SR_ADDRESSES = new Map<string, string>()
SR_ADDRESSES.set('mainnet', '0xFdDf38947aFB03C621C71b06C9C70bce73f12999'.toLowerCase())
SR_ADDRESSES.set('goerli', '0xa3Dbd317E53D363176359E10948BA0b1c0A4c820'.toLowerCase())
SR_ADDRESSES.set('holesky', '0xd6EbF043D30A7fe46D1Db32BA90a0A51207FE229'.toLowerCase())

const BURNER_ADDRESSES = new Map<string, string>()
BURNER_ADDRESSES.set('mainnet', '0xD15a672319Cf0352560eE76d9e89eAB0889046D3'.toLowerCase())
BURNER_ADDRESSES.set('goerli', '0x20c61C07C2E2FAb04BF5b4E12ce45a459a18f3B1'.toLowerCase())
BURNER_ADDRESSES.set('holesky', '0x4E46BD7147ccf666E1d73A3A456fC7a68de82eCA'.toLowerCase())
