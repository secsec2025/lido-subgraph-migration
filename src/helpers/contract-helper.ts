...
import {Contract as HashConsensusContract} from '../abi/HashConsensus';
...
export const getChainConfigFromHashConsensusContract = async (contractAddress: string, ctx: any, logEvent: any) => {
    const contract = new HashConsensusContract(ctx, {height: logEvent.block.height}, contractAddress);
    return await contract.getChainConfig();
}