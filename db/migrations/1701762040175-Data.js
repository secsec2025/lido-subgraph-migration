module.exports = class Data1701762040175 {
    name = 'Data1701762040175'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "node_operators_shares" ("id" character varying NOT NULL, "total_reward_id" character varying, "address" text NOT NULL, "shares" numeric NOT NULL, CONSTRAINT "PK_5ed87e57834752491eb01a3a1d8" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "oracle_report" ("id" character varying NOT NULL, "total_reward_id" character varying, "hash" text NOT NULL, "items_processed" numeric NOT NULL, "items_count" numeric NOT NULL, CONSTRAINT "PK_05828c08e675f0f5c4baa96493e" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "objection" ("id" character varying NOT NULL, "objector" text NOT NULL, "weight" numeric NOT NULL, "motion_id" character varying, "block" numeric NOT NULL, "block_time" numeric NOT NULL, "transaction_hash" text NOT NULL, "log_index" numeric NOT NULL, CONSTRAINT "PK_f66a92a8254c445494f6cc3be60" PRIMARY KEY ("id"))`)
